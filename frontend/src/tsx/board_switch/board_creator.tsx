	...
	function getBody(): JSX.Element {
		return <div className="editModal">
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="forceEditor">
					<div className="forceEditorLeft">
						<div>力語言</div>
					...
					<div className="forceEditorRight">
						<div>範本</div>
						<div className="forceExampleList">
							{
								forceExamples.map(example => (
									<div className="forceExample" key={example.name} onClick={() => setForceValue(example.force.join('\n'))}>
										{example.name}
									</div>
								))
							}
